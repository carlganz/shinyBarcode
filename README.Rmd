...
[![Travis-CI Build Status](https://travis-ci.org/CannaData/CannaBarcode.svg?branch=master)](https://travis-ci.org/CannaData/CannaBarcode)[![AppVeyor Build Status](https://ci.appveyor.com/api/projects/status/github/CannaData/CannaBarcode?branch=master&svg=true)](https://ci.appveyor.com/project/CannaData/CannaBarcode)
